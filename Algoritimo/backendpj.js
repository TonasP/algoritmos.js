...
let opcao=0 
let ficha =[
     {Nome:"Corre",tipolinha1:"Poliester",tipolinha2:"Poliester", cor1:"Red Velvet", cor2:"Snow", cor3:"--", lowmelt:"Clear",monofio1:"Eletric Orange", monofio2:"--", quantidade:"2 pares, 1D", nomeFuncionario:"Thomaz" }
]
...
function editar(){
    ...
    function adicionar(){
      ...
      novoItem.nomeFuncionario = prompt("Insira o seu nome:")
      ficha.push(novoItem);
    ...
    function verificacao(){
        let usuario= prompt("Qual o numero da sua matricula?")
        if (usuario.length<5 || usuario.length>5 || usuario===NaN){
            console.log("Matricula inválida, por favor, insira um matricula válida! ")
            return verificacao()
        }
        else {
            console.log ("Matricula validada com sucesso, redirecionando para o menu! ")
            menu()
        }
    } 
    function menu(){
 ...
 module.exports = {visualizar, editar, adicionar, remover, verificacao, menu, iniciarMenu }